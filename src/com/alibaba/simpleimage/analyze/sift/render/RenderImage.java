...
public class RenderImage {
    ...
    public RenderImage(Bitmap srcImage){
    ...
    public float scaleWithin(int dim) {
        ...
        // 创建一个缩小后的位图
        Bitmap bmScalaed = Bitmap.createScaledBitmap(srcImage, (int) (this.srcImage.getWidth() * smallestScala + 0.5), (int) (this.srcImage.getHeight() * smallestScala + 0.5), false);
        // TODO,这里可以优化
